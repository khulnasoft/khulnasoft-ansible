Ansible Playbook - Khulnasoft manager
================================

This role will install the Khulnasoft manager on a host.
...
```
---
khulnasoft_manager_fqdn: "khulnasoft-server"
...
khulnasoft_manager_config:
  ...
  mail_from: khulnasoft-server@example.com
  syscheck:
    frequency: 43200
    scan_on_start: 'yes'
    ignore:
...
Including an example of how to use your role (for instance, with variables passed in as parameters) is always nice for users too:
    ...
    - hosts: khulnasoft-server.example.com
      roles:
         - { role: ansible-khulnasoft-server }
